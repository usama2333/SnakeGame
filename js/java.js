...
const musicSound = new Audio('sounds/themesong.mp3');
...
function gameEngine(){
    ...
    //Upadte the snake array and food
    ...
    //If eat the food score is add and food is regenerate
